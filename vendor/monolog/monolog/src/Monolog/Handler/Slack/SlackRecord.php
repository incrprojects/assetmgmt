...
class SlackRecord {
    ...
    public function getSlackData(array $record): array {
        ...
        if($this->useAttachment) {
            $attachment = array('fallback' =>$message,
                                'text' =>$message,
    ...
    public function getAttachmentColor(int $level): string {
        switch(true) {
            case $level >= Logger::ERROR : return static::COLOR_DANGER;
            case $level >= Logger::WARNING : return static::COLOR_WARNING;
            case $level >= Logger::INFO : return static::COLOR_GOOD;
            default : return static::COLOR_DEFAULT;
        }
    }
    ...
    private function generateAttachmentField(string $title, $value): array {
        ...
        return array('title' => ucfirst($title),
                     'value' =>$value,
                     'short' => false,
                    );
    }
