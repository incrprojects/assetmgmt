...
class BrowserConsoleHandler extends AbstractProcessingHandler {
    ...
    private static function handleCustomStyles(string $style, string $string): string {
       ...
       , $style);
        if(null === $style) {
            ...
            throw new \RuntimeException('Failed to run preg_replace_callback: ' . 
                                        $pcreErrorCode . 
                                        ' / ' . 
    ...
    private static function call(. 
        ...
        if(!is_string($method)) {
            throw new \UnexpectedValueException('Expected the first arg to be a string, got: ' . 
